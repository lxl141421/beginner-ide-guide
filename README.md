...
|---------|--------|---------|---------|------|------|
| **全语言** | **[VS Code](https://code.visualstudio.com)** | 1.124.2 | 2026-06-12 | **Win/Mac/Linux** | **市占率第一，插件 3 万+，远程开发/Dev Containers** |
| 全语言 | [Zed](https://zed.dev) | 1.6.3 | 2026-06-10 | Mac/Linux | GPU 加速渲染，多光标协作，Rust 编写极速启动 |

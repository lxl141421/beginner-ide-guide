...
|------|-----|---------|---------|------|------|
| Python | [WinPython](https://winpython.github.io) | 17.12.20260522/WinPython | 2026-08-23 | Windows | 便携免安装，数据科学选 **free** 版，只学基础选 **slim** 版 |
...
| 语言 | IDE | 最新版本 | 更新时间 | 平台 | 亮点 |
|------|-----|---------|---------|------|------|
| Java/Kotlin | [IntelliJ IDEA CE](https://www.jetbrains.com/idea/) · [下载](https://www.jetbrains.com/idea/download/) | 2026.2.2 | 2026-09-07 | Win/Mac/Linux | Java 开发行业标准，重构/补全/调试一体，社区版免费 |
...
| 语言 | IDE | 最新版本 | 更新时间 | 平台 | 亮点 |
|------|-----|---------|---------|------|------|
| Python | [Spyder](https://www.spyder-ide.org) | 6.1.7 | 2026-08-28 | Win/Mac/Linux | 数据科学专用，变量浏览器实时查看 DataFrame，类 MATLAB |
...
| 语言 | IDE | 最新版本 | 更新时间 | 平台 | 亮点 |
|------|-----|---------|---------|------|------|
| C++/C#/.NET | [Visual Studio Community](https://visualstudio.microsoft.com/vs/) · [社区版](https://visualstudio.microsoft.com/vs/community/) | 2022 17.14 | 2026-09-08 | Windows | C++/C# 开发最强，IntelliSense 智能补全，社区版免费 |
...
|---------|--------|---------|---------|------|------|
| 全语言 | [Zed](https://zed.dev) | 1.19.2 | 2026-09-09 | Win/Mac/Linux | GPU 加速渲染，多光标协作，Rust 编写极速启动 |
| **全语言** | **[VS Code](https://code.visualstudio.com)** | 1.137.0 | 2026-09-09 | **Win/Mac/Linux** | **市占率第一，插件 3 万+，远程开发/Dev Containers** |
...
| VS Code | 2026-09-09 | ✅ |
| Zed | 2026-09-09 | ✅ |
| Visual Studio Community | 2026-09-08 | ✅ |
| IntelliJ IDEA CE | 2026-09-07 | ✅ |
| BlueJ | 2026-09-04 | ✅ |
| Spyder | 2026-08-28 | ✅ |
| Emacs | 2026-08-24 | ✅ |

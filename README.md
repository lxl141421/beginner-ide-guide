...
|---------|--------|---------|---------|------|------|
| 全语言 | [Zed](https://zed.dev) | 1.16.1 | 2026-08-19 | Win/Mac/Linux | GPU 加速渲染，多光标协作，Rust 编写极速启动 |
| **全语言** | **[VS Code](https://code.visualstudio.com)** | 1.134.0 | 2026-08-19 | **Win/Mac/Linux** | **市占率第一，插件 3 万+，远程开发/Dev Containers** |
